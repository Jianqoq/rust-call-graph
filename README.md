...
- Source Expansion combines rust-analyzer semantic tokens with a lexical Rust fallback, so keywords, literals, strings, comments, and lifetimes retain syntax color even when the provider omits those token classes.
