...
- The expanded source node is an anchor during that promotion. If a target shares its column, the origin node and its cell remain fixed while only the other column cells are reordered.
