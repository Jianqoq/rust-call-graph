...
The relationship origin is not a candidate in its own recency permutation. When an inspected target shares the origin's rank column, the origin node and its row cell stay reserved; only the remaining nodes and cells may exchange ownership.
