...
- `pnpm package` — produces a 183.23 KB installable VSIX containing only the extension bundle, Webview bundle, styles, README, changelog, and license.
