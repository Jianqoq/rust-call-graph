...
- `pnpm package` — produces a 180.14 KB installable VSIX containing only the extension bundle, Webview bundle, styles, README, changelog, and license.
