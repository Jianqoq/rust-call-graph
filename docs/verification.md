...
- `pnpm package` — produces a 183.49 KB installable VSIX containing only the extension bundle, Webview bundle, styles, README, changelog, and license.
