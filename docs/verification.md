...
- `pnpm package` — produces a 180.34 KB installable VSIX containing only the extension bundle, Webview bundle, styles, README, changelog, and license.
