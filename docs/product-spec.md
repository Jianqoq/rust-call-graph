...
- Source syntax uses rust-analyzer semantic tokens and current VS Code theme colors. The initial viewport maintains a readable zoom floor; **Fit** remains available for a complete overview.
