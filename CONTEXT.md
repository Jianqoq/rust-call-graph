...
**Recent Target**:
A Function Node most recently reached by hovering or selecting a Call Site or Function Reference. Within its shared rank column, newer Recent Targets occupy cells closer to the source and older ones progressively farther away. An active browsing chain retains its ancestor placements when a Recent Target becomes the next source; manually translating a column carries every Recent Target with it.
